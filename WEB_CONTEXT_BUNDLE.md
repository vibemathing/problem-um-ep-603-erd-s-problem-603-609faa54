...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-603-erd-s-problem-603-609faa54-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-603"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-603-erd-s-problem-603-609faa54-v1",
      "problem_contract_sha256": "62c044b152e5f77399c95f2dcc6e354667b5d3c7c710d0dec077067ee1cea6da",
      "problem_id": "problem:um-ep-603-erd-s-problem-603-609faa54",
      "route_id": "route:um-ep-603-erd-s-problem-603-609faa54-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-603-erd-s-problem-603-609faa54-source-fidelity-01",
      "graph_id": "graph:um-ep-603-erd-s-problem-603-609faa54-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-603-erd-s-problem-603-609faa54-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-603-erd-s-problem-603-609faa54-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $(A_i)$ be a family of countably infinite sets such that $\\lvert A_i\\cap A_j\\rvert eq 2$ for all $i eq j$. Find the smallest cardinal $C$ such that $\\cup A_i$ can always be coloured with at most $C$ colours so that no $A_i$ is monochromatic."
          },
          "statement_sha256": "4afde4fd5a58322bf70dd8023f5425cd464ecb3ecf137098d843037f1e75244e"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-603-erd-s-problem-603-609faa54-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-603-erd-s-problem-603-609faa54-root",
      "route_id": "route:um-ep-603-erd-s-problem-603-609faa54-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-603-10dba848f6bb",
        "url": "https://www.unsolvedmath.com/problems/EP-603"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
